...
Requirements:
1. Latex system.
2. Optional (TeXnicCenter) -> Latex GUI editor.

Package information:
1. The main file of this project is 'Thesis Description.tex'
2. If you use TeXnicCenter, you can direct open the 'Thesis Description.tcp'
