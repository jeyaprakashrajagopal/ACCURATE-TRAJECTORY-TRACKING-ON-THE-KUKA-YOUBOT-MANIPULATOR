...
data = dlmread("manipulator_joint4_innerloop_0pt5rads.txt", ",");
...
legend('Setpoint', 'Measured values', 'Smoothened', 'Location', 'South');

set(findall(gca, 'Type', 'Line'),'LineWidth',5);

set(findall(gca, 'Type', 'Line'),'LineWidth',5);

print -dpng joint4_innerloop_0pt5rads.png;
